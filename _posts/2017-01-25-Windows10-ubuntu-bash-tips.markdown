---
layout: post
title:  "Windows 10 Ubuntu Bash Tips"
date:   2017-01-25
categories: windows10 bash
tags: windows10 ubuntu bash
---
...
1. Open interactive shell script. 

   ```console 
   $ nano ~/.bashrc
   ```
   
2. At the end of the document add the following lines:
